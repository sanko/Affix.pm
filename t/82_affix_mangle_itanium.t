...
subtest 'setup(int i)' => sub {
    ...
    subtest 'MyClass::speed(...)' => sub {
        ...
        #my $set_speed = wrap( [ $lib, ABI_ITANIUM ] => 'MyClass::speed' => [Int] => Int )->(300);
        ...
        is wrap( [ $lib, ABI_ITANIUM ],
            'MyClass::speed' => [ CC_THISCALL, Pointer [Void] ] => Int )->($ptr), 3,
            'this->speed() == 3';
        wrap( [ $lib, ABI_ITANIUM ],
            'MyClass::speed' => [ CC_THISCALL, Pointer [Void], Int ] => Void )->( $ptr, 400 );
        diag 'this->speed(400)';
        is wrap( [ $lib, ABI_ITANIUM ],
            'MyClass::speed' => [ CC_THISCALL, Pointer [Void] ] => Int )->($ptr), 400,
            'this->speed() == 400';
    }
};
#
