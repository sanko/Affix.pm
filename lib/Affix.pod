...
Vectors (e.g. C<__m128>, C<__m256>, C<__m512> on x86; C<float32x4_t> on ARM) are first-class types in Affix.
...
Full examples can be found in the C<eg/> directory, Affix based modules are on CPAN (L<SDL3>) but here are a few to get you started.
