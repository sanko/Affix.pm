...
C<Affix::Pointer> class. A Pin is a reference to a scalar holding the memory address, blessed with magic and
...
C<Affix::Pointer> objects overload array dereferencing (C<@$ptr>). This allows you to use standard Perl array syntax
